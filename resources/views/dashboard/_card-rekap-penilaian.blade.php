...
<div class="row">
    ...
    <div class="col-md-5">
        <div class="card card-default">
            <div class="card-header"><h3 class="card-title">Chart Progres Penilaian Perangkat Daerah</h3></div>
            <div class="card-body">
    ...
    <div class="col-md-7">
        <div class="card card-default">
            <div class="card-header"><h3 class="card-title">Top 10 Progres Penilaian Perangkat Daerah</h3></div>
            <div class="card-body">
                <div style="overflow:auto;">
                    <table class="table table-bordered mb-0 table-sm">
                        ...
                        <tbody>
                            @forelse($allInstansiProgresPenilaianTertinggi as $instansi)
                                <tr>
...
<script>
(function () {
    const labels = @json($distribusiPenilaian['labels']);
    const data   = @json($distribusiPenilaian['values']);
