        ...
        @if (\App\Components\Session::isInstansi())
            @if ($dokumenModel->getFileUrl('file', \App\Models\Dokumen::FOLDER_FILE))
                <div class="alert alert-success">
                    Dokumen Berita Acara sudah diunggah, silahkan klik lihat file untuk meninjau hasil file yang diunggah.
                </div>
            @else
                <div class="alert alert-danger">
                    Dokumen Berita Acara belum diunggah! Silahkan unggah terlebih dahulu atau klik export word untuk mengunduh dokumen template.
                </div>
            @endif
        @endif
